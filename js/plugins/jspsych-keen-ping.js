        ...
        function(err, res){
          if (err) {
            ...
            '<div id="jspsych-html-keyboard-response-stimulus">' +
              '<p><i class="fa fa-times"></i> La connexion avec nos serveurs n\'a pas pu être établie.' +
              '<br><br>Veuillez désactiver votre ad blocker et rafraîchir la page</p>' +
            ...
            new_html =
            '<div id="jspsych-html-keyboard-response-stimulus">' +
            '<p><i class="fa fa-check"></i> La connexion avec nos serveurs a pu être établie.</p>' +
            '<p class="continue-instructions"><i>Appuyez sur ESPACE pour continuer.</i></p>' +
